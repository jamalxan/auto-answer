...
export const uz = {
  ...
  footer: {
    tagline: "Rasmiy Meta API asosida Instagram \"izoh → DM\" kampaniyalari.",
    product: "Mahsulot",
    legal: "Yuridik",
    linkTemplates: "Shablonlar",
    linkCommentLink: "Izohga LINK avtomatlashtirish",
    linkManychat: "Manychat alternativasi",
    linkAgencies: "Agentliklar uchun",
    linkPrivacy: "Maxfiylik siyosati",
    linkTerms: "Foydalanish shartlari",
    linkDataDeletion: "Ma'lumotlarni o'chirish",
    linkSignIn: "Kirish",
    rights: (year) => `© ${year} SocialAuto. Barcha huquqlar himoyalangan.`,
  },
  admin: {
    navLabel: "Admin",
    title: "Platforma boshqaruvi",
    subtitle: "Barcha ish maydonlari bo'yicha umumiy ko'rinish: egalari va foydalanish ko'rsatkichlari.",
    statWorkspaces: "Ish maydonlari",
    statUsers: "Foydalanuvchilar",
    statInstagramAccounts: "Instagram akkauntlari",
    statActiveCampaigns: "Faol kampaniyalar",
    statDmsAllTime: "Yuborilgan DM (jami)",
    statDmsLast30Days: "Yuborilgan DM (30 kun)",
    statNewWorkspaces30Days: "Yangi ish maydonlari (30 kun)",
    workspacesTitle: "Ish maydonlari",
    colWorkspace: "Ish maydoni",
    colOwner: "Egasi",
    colCreated: "Yaratilgan",
    colMembers: "A'zolar",
    colAccounts: "Akkauntlar",
    colCampaigns: "Kampaniyalar",
    ...
    pricingFieldName: "Nomi",
    pricingFieldDescription: "Tavsif",
    pricingFieldFeatures: "Xususiyatlar",
    pricingFeaturesHint: "Har bir xususiyatni yangi qatorga yozing.",
    pricingLocaleUz: "O'zbekcha",
    pricingLocaleRu: "Ruscha",
    pricingLocaleEn: "Inglizcha",
    pricingSave: "Saqlash",
    ...
    navStats: "Statistika",
    navWorkspaces: "Ish maydonlari",
    navPricing: "Narxlar",
    navSettings: "Sozlamalar",
    navLogout: "Chiqish",
    statsTitle: "Platforma boshqaruvi",
    statsSubtitle: "Barcha ish maydonlari bo'yicha umumiy ko'rinish: egalari va foydalanish ko'rsatkichlari.",
    settingsTitle: "Sozlamalar",
    settingsChangePassword: "Parolni o'zgartirish",
    settingsCurrentPassword: "Joriy parol",
    settingsNewPassword: "Yangi parol",
    settingsConfirmPassword: "Yangi parolni takrorlang",
    settingsSave: "Parolni saqlash",
    settingsSuccess: "Parol yangilandi.",
    settingsErrorTooShort: "Parol kamida 8 belgidan iborat bo'lishi kerak.",
    settingsErrorMismatch: "Parollar mos kelmadi.",
    settingsErrorWrongCurrent: "Joriy parol noto'g'ri.",
  },
