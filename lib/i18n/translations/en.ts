...
export const en = {
  ...
  admin: {
    ...
    pricingFieldName: "Name",
    pricingFieldDescription: "Description",
    pricingFieldFeatures: "Features",
    pricingFeaturesHint: "One feature per line.",
    pricingLocaleUz: "Uzbek",
    pricingLocaleRu: "Russian",
    pricingLocaleEn: "English",
    pricingSave: "Save",
    ...
    navLogout: "Log out",
    statsTitle: "Platform Admin",
    statsSubtitle: "Cross-workspace overview: every workspace, owner, and usage total.",
    ...
    settingsSave: "Save password",
    settingsSuccess: "Password updated.",
    settingsErrorTooShort: "Password must be at least 8 characters.",
    settingsErrorMismatch: "Passwords don't match.",
    settingsErrorWrongCurrent: "Current password is incorrect.",
  },
