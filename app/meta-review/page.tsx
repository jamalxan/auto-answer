...
export default function MetaReviewPage() {
  return (
    <LegalShell
      ...
      description="SocialAuto is designed for Instagram professional accounts that want to send private replies after keyword comments on their own posts or reels."
    ...
    >
      <section>
        ...
        <p className="mt-3">
          ...
          reel, and receives a webhook when someone comments. SocialAuto queues
